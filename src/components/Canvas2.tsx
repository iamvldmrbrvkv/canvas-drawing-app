...
//   function handleAddShape(_e: Konva.KonvaEventObject<MouseEvent>) {
    
//         const stage = stageRef.current;
//     const toggleDraggable = () => {
//       if (stageRef.current) {
//         // Получаем доступ к сцене через реф и переключаем draggable
//         stageRef.current.draggable(!isDraggable); // Меняем значение draggable
//         setIsDraggable(!isDraggable); // Обновляем состояние
...
//         setScaleShapeId(id)
//     console.log('scaleShapeId', scaleShapeId)
//     }
    
//     function handleScaleShape(_e: Konva.KonvaEventObject<MouseEvent>) {
//       if(scaleShapeId != '') {
...
//     function handleScaleShapeStop(_e: Konva.KonvaEventObject<MouseEvent>) {
...
//       // onMouseMove={handleScaleShape}
//       onMouseUp={handleScaleShapeStop}
//       // onMouseOver={handleScaleShapeStop}
